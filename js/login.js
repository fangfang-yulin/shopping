...
function Logo(){
	...
	l_box.style.left = (e.clientWidth/2-l_box.offsetWidth/2)+'px';
	l_box.style.top = (e.clientHeight/2-l_box.offsetHeight/2)+'px';
	...
	divs.style.width=document.body.clientWidth;
	divs.style.height=document.body.clientHeight;
