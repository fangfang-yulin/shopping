...
Pagination.prototype.isDis = function () {
  if (this.default.pageInfo.pagenum === 1) {
    ...
    this.ele.children[0].style.backgroundColor = '#fff'
    this.ele.children[1].style.backgroundColor = '#fff'
    this.ele.children[0].style.color = '#d2d2d2'
    this.ele.children[1].style.color = '#d2d2d2'
    this.ele.children[0].style.cursor='not-allowed'
    this.ele.children[1].style.cursor='not-allowed'
  }

  if (this.default.pageInfo.pagenum === this.default.pageInfo.totalpage) {
    this.ele.children[3].style.backgroundColor = '#fff'
    this.ele.children[4].style.backgroundColor = '#fff'
    this.ele.children[3].style.color = '#d2d2d2'
    this.ele.children[4].style.color = '#d2d2d2'
    this.ele.children[3].style.cursor='not-allowed'
    this.ele.children[4].style.cursor='not-allowed'
  }
}
